...
const STYLES: Record<ButtonVariant, string> = {
  ...
  nav: "p-3.75 font-medium text-[20px] text-[#525252] hover:text-[#4F46E5]",
  link: "text-[20px] font-medium text-[#4F46E5] underline",
  icon: "p-0!",
  "danger-nav": "gap-1.75! text-[16px] font-medium text-[#8A8A8A] hover:text-[#4F46E5]",
  ...
  "dialog-icon": "p-0! transition-opacity",
  ...
  "sort-option": "w-full justify-start px-5 py-2.5 text-[16px] font-medium hover:bg-[#EEEDFC]",
